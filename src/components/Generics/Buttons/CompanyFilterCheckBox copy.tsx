...
import { updateBrandFilter } from "../../../redux/actions/actions";
...
interface BrandFilterCheckBoxProps {
    type: string;
    // isComplete?: boolean;
    // clickEvent?: () => {};
}

export const BrandFilterCheckBox: React.FC<BrandFilterCheckBoxProps> = ({type}) => {
    ...
    return (
        <>
            ...
            <CheckBoxDiv onChange={(e) => dispatch(updateBrandFilter(type, e.target.checked ))} />
